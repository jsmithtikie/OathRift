 ...
 * This file demonstrates how to integrate Oathrift with a web frontend
 */

// For React/Vue/Angular applications
export class OathriftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new OathriftClient(provider, contractAddress);
